...
Request &Request::operator=(const Request &other) {
  if (this != &other) {
    ...
    this->m_route_length = other.m_route_length;
    this->m_route = other.m_route;
...
std::string Request::get_route() const { return m_route; }

std::string Request::get_body() const { return m_body; }

u_int32_t Request::m_get_total_length() const {
  return 1 + 4 + m_route_length + 4 + m_body_length;
}
